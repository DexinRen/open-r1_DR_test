...
math_220k = LightevalTaskConfig(
    name="math_220k",
    suite=["custom"],
    prompt_function=prompt_fn,
    hf_repo="open-r1/OpenR1-Math-220k",
    hf_subset="default",
    hf_avail_splits=["train"], # they only have train split, this can only be used for the acc on training set
    evaluation_splits=["train"], # limit the size, the dataset got 93k rows of data and the VRAM gonna explod LOL, Find a way to shuffle it for better result
    few_shots_split=None,
    few_shots_select=None,
    generation_size=32768, 
    metric=[latex_gold_metric],
...
gpqa_experts = LightevalTaskConfig(
    name="gpqa:expert",
    suite=["custom"],
    prompt_function=gpqa_prompt_fn,
    hf_repo="Idavidrein/gpqa",
    hf_subset="gpqa_experts",
    hf_avail_splits=["train"],
    evaluation_splits=["train"],
    few_shots_split=None,
    few_shots_select=None,
...
gpqa_extended = LightevalTaskConfig(
    name="gpqa:extended",
    suite=["custom"],
    prompt_function=gpqa_prompt_fn,
    hf_repo="Idavidrein/gpqa",
...
TASKS_TABLE.append(gpqa_extended)
TASKS_TABLE.append(math_220k)
